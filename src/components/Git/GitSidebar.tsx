...
export default function GitSidebar({ projectPath, onFileClick, aiProvider }: GitSidebarProps) {
  ...
  return (
    ...
    >
      ...
      <CommitBox
        ...
        onPush={handlePush}
        onPull={handlePull}
        onGenerateMessage={() => window.sai.claudeGenerateCommitMessage(projectPath, aiProvider)}
