...
export default function TerminalModeView({ projectPath, aiProvider = 'claude', active = true }: TerminalModeViewProps) {
  ...
  const handleAIRequest = useCallback((prompt: string) => {
    ...
    if (!preambleSentRef.current) {
      ...
      const preamble = [
        'You are a general-purpose AI terminal assistant — like a smart command line that can answer questions, run commands, and help with any task.',
        '',
        ...
        '- Assist with any topic the user brings up — you are not limited to coding',
        '',
        'When the user asks about code, a project, or development tasks, shift into developer mode:',
        ...
        '- Read files, run diagnostic commands, and report findings',
        '',
        'General guidelines:',
